...
const RemoveBackground = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // const prompt = `Remove background from ${input}`;
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4">
      ...
      >
        ...
        <p className="mt-6 text-sm font-medium">Upload File</p>
        <input
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-2 text-sm rounded-lg cursor-pointer mt-5"
        >
          {loading ? (
